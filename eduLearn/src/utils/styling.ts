...
export const useThemedStyles = () => {
  ...
  return {
    ...
    getBackgroundStyle: (variant: 'primary' | 'secondary' | 'surface' | 'card' = 'primary') => ({
      backgroundColor: theme.colors[variant === 'primary' ? 'background' : variant],
    }),
    
    getTextStyle: (variant: 'primary' | 'secondary' = 'primary') => ({
      color: variant === 'primary' ? theme.colors.text : theme.colors.textSecondary,
    }),
